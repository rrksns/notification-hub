// analytics-service SecurityConfig의 직접 호출 차단 정책을 검증하는 테스트
package com.notificationhub.analytics.infrastructure.security;
...
class SecurityConfigTest {
    ...
    @Test
    @DisplayName("분석 보호 경로는 토큰 없이 401을 반환한다")
    void analytics_withoutToken_returnsUnauthorized() throws Exception {
        mockMvc.perform(get("/api/analytics/security-probe")
    ...
    void analytics_withValidToken_usesTrustedTenantHeader() throws Exception {
    ...
    static class SecurityProbeController {
        ...
        @GetMapping("/api/analytics/security-probe")
        String protectedAnalytics(@RequestHeader("X-Tenant-Id") String tenantId) {
            return tenantId;
        }
