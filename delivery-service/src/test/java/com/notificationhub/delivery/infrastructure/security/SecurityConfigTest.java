// delivery-service SecurityConfig의 직접 호출 차단 정책을 검증하는 테스트
...
class SecurityConfigTest {
    ...
    @Test
    @DisplayName("발송 보호 경로는 토큰 없이 401을 반환한다")
    void deliveries_withoutToken_returnsUnauthorized() throws Exception {
        mockMvc.perform(get("/api/deliveries/security-probe")
    ...
    void deliveries_withValidToken_usesTrustedTenantHeader() throws Exception {
    ...
    static class SecurityProbeController {
        ...
        @GetMapping("/api/deliveries/security-probe")
        String protectedDelivery(@RequestHeader("X-Tenant-Id") String tenantId) {
            return tenantId;
        }
